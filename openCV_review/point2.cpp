...
{
	// Point_ 객체 선언 방식
	cv::Point_<int> pt1(100, 200); // 가로 100, 세로 200
	...
	// Point_ 객체 연산
	cv::Point pt8 = pt1 + (cv::Point)pt2; // 자료형이 다른 Point_ 객체 덧셈
	cv::Point2f pt9 = pt6 * 3.14f; // 스칼라 곱
	cv::Point2d pt10 = (pt3 + (cv::Point2d)pt6) * 10;
	
	std::cout << "pt8 = " << pt8.x << " , " << pt8.y << std::endl; // x는 100 + 92.3 y는 200 + 125.23
	std::cout << "[pt9] = " << pt9 << std::endl;
	std::cout << "(pt2 == pt6) = " << (pt2 == pt6) << std::endl;
